...
def _get_guardian_prompt_path() -> Path | None:
    ...
    try:
        from tools.approval_smart import _get_guardian_config
...
def cmd_approvals_status(args) -> None:  # noqa: ARG001
    ...
    from tools.approval_smart import _get_guardian_config, _is_guardian_enabled
...
def cmd_approvals_refine(args) -> None:  # noqa: ARG001
    ...
    activity_data = ""
    try:
        from tools.approval_smart import _session_activity
